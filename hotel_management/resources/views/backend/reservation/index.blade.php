...
{{-- <div class="form-row mt-4">
    ...
    <div class="col">
    <div class="mb-3">
    <input type="text" name="id" value="{{old('id')}}"  class="form-control"  aria-describedby="PriceHelp" placeholder="UID">
    ...
    <div class="col">
    <div class="mb-3">
    <input type="text" name="name" value="{{old('name')}}" class="form-control"  aria-describedby="PriceHelp" placeholder="Guest Name">
