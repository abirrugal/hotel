...
<div style="padding: 3px 150px;">
    ...
    <form action="{{route('admin.check_out_filter')}}" method="POST">
    @csrf
 ...
 <div class="col-lg-12 mt-5">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="header-title text-center">Check Out Manage</h4>
                            ...
                            <tr>
                                ...
                                <td class="font_sm">{{ \Carbon\Carbon::parse($info->departure_date)->format('d/m/Y') }}</td>                  
                                     ...
                                     {{--  <a class="mt-2 mr-3 btn btn-success me-3 btn-sm" href="{{route('admin.check_in.out', $info->id)}}"><i class="fas fa-sign-out-alt"></i> Check Out</a>  --}}
                                        ...
                                        @if (auth()->user()->role_as === 'superadmin')
                                        <form class="d-inline " onclick="return confirm('Sure to delete product ?')"  action="{{route('admin.check_out.delete', $info->id)}}" method="POST">
                                            @csrf
                                            @method('Delete')
